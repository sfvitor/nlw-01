...
const CreatePoint = () => {
    ...
    useEffect(() => {
        (async function () {
            const result = await ibge.get<IBGEUFResponse[]>('/localidades/estados');
    ...
    useEffect(() => {
        ...
        (async function() {
            const result = await ibge.get<IBGECityResponse[]>(`/localidades/estados/${selectedUF}/municipios`);
            const citiesNames = result.data.map(city => city.nome);
